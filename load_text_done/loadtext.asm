...
.segment "ZEROPAGE"
Frame:   .res 1              ; 1 byte for a counter of frames
Clock60: .res 1              ; 1 byte for a counter of seconds (1 second = 60 frames)
BgPtr:   .res 2              ; 2 bytes (16 bits) for a pointer to the background address (lo-byte, hi-byte)
