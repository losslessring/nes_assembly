...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
.macro LoadText ppuAddress
    PPU_SETADDR ppuAddress        ; Set the nametable position where the text starts

    ldy #0                   ; Y = 0
    ldy #0                   ; Y = 0
    ldy #0                   ; Y = 0
Loop:
    lda Message,y        ; Fetch character byte from ROM
...
Main:
    ...
    LoadText $21CC           ; Call LoadText macro to draw the text message on the nametable at given address
...
Message:
.byte $11,$0E,$15,$15,$18,$24,$20,$18,$1B,$15,$0D,$0
